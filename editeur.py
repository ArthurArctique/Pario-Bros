...
for i in info:
    if info[i][0] == 'vide.png':
        image[i] = [pygame.transform.scale(pygame.image.load(f'assets/monstres/{info[i][4]}'),(int(810/15) * scale * info[i][6],int(810/15) * scale * info[i][7] )),i]
    else:
        image[i] = [pygame.transform.scale(pygame.image.load(f'Europe/assets/blocs/{info[i][0]}'),(int(810/15) * scale * info[i][6],int(810/15) * scale * info[i][7] )),i]
